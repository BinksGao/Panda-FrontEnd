...
export const BASE_URL = 'https://testnet.pandadao.finance'
export const BASE_EXCHANGE_URL = 'https://testnet_exchange.pandadao.finance'
...
export const NEW_DEFAULT_GAS_LIMIT = 300000
