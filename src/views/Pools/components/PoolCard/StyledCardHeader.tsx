...
import { CardHeader, Heading, Text, Flex, Image } from 'bambooswap-frontend-uikit'
...
const StyledCardHeader: React.FC<{
  ...
  const isCakePool = earningTokenSymbol === 'FEL' && stakingTokenSymbol === 'FEL'
